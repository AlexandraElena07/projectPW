...
if(isset($_POST['add_book'])){
    ...
    $b_publishing = $_POST['b_publishing'];
    ...
    $insert_query = mysqli_query($conn, "INSERT INTO `secondaryschool`(title, author, publishing, subject, class, price, no, image) VALUES('$b_title', ' $b_author', '$b_publishing', ' $b_subject', ' $b_class', '$b_price', '$b_no', '$b_image')") or die ('query failed');
...
if(isset($_GET['delete'])){
    ...
    $delete_query = mysqli_query($conn, "DELETE FROM `secondaryschool` where id = $delete_id");
    if($delete_query){
...
if(isset($_POST['update_book'])){
    ...
    $update_query = mysqli_query($conn, "UPDATE `secondaryschool` SET price = '$update_b_price', no = '$update_b_no' WHERE id = '$update_b_id'");
...
<div class="container-books">
   <section>
        <form action="" method="post" class="add-book-form" enctype="multipart/form-data">
            ...
            <input type="text" name="b_publishing" placeholder="Enter the book publisher" class="box" required>
            <input type="text" name="b_subject" placeholder="Enter the school subject" class="box" required>
            <input type="number" name="b_class" min="0" max="12" placeholder="Enter the class" class="box" required>
        ...
        <table class="table-auto">
            ...
            <tbody>
                <?php
                    ...
                    $select_books = mysqli_query($conn, "SELECT * FROM `secondaryschool`");
                ...
                <tr>
                    ...
                    <td>
                        <a href="adminsecondaryschool.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('Are you sure that you want to delete this?');"> <i class="fas fa-trash"></i> Delete </a>
                        <a href="adminsecondaryschool.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class = "fas fa-edit"> </i> Update </a>
                    </td>
                </tr>
   ...
   <section class="edit-form-container">
     ...
     if(isset($_GET['edit'])){
        $edit_id = $_GET['edit'];
        $edit_query = mysqli_query($conn, "SELECT * FROM `secondaryschool` WHERE id = $edit_id");
...
<!-- custom js file link  -->
<script src="js/scriptsecondary.js"></script>
